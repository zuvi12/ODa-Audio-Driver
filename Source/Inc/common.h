...
#ifndef _ODAAUDIODRIVER_COMMON_H_
#define _ODAAUDIODRIVER_COMMON_H_
...
//
//=============================================================================
typedef struct _ODAAUDIODRIVER_DEVPROPERTY {
    const DEVPROPKEY   *PropertyKey;
    DEVPROPTYPE Type;
    ULONG BufferSize;
    __field_bcount_opt(BufferSize) PVOID Buffer;
} ODAAUDIODRIVER_DEVPROPERTY, PODAAUDIODRIVER_DEVPROPERTY;
...
typedef struct _ENDPOINT_MINIPAIR 
{
    ...
    // Topology miniport.
    PWSTR                           TopoName;               // make sure this or the template name matches with ODAAUDIODRIVER.<TopoName>.szPname in the inf's [Strings] section
    ...
    const ODAAUDIODRIVER_DEVPROPERTY*       TopoInterfaceProperties;

    // Wave RT miniport.
    PWSTR                           WaveName;               // make sure this or the template name matches with ODAAUDIODRIVER.<WaveName>.szPname in the inf's [Strings] section
    ...
    const ODAAUDIODRIVER_DEVPROPERTY*       WaveInterfaceProperties;
...
#endif  //_ODAAUDIODRIVER_COMMON_H_
