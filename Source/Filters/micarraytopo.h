...
#ifndef _ODAAUDIODRIVER_MICARRAYTOPO_H_
#define _ODAAUDIODRIVER_MICARRAYTOPO_H_
...
class CMicArrayMiniportTopology :
    public CMiniportTopologyODaAudioDriver,
...
public:
    ...
    (
        ...
        CMiniportTopologyODaAudioDriver(FilterDesc, DeviceMaxChannels),
...
#endif // _ODAAUDIODRIVER_MICARRAYTOPO_H_
