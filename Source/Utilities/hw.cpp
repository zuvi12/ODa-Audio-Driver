...
CODaAudioDriverHW::CODaAudioDriverHW()
: m_ulMux(0),
...
Routine Description:
    ...
    Constructor for ODaAudioDriverHW. 
...
//=============================================================================
BOOL
CODaAudioDriverHW::bGetDevSpecific()
/*++
...
//=============================================================================
void
CODaAudioDriverHW::bSetDevSpecific
(
...
//=============================================================================
INT
CODaAudioDriverHW::iGetDevSpecific()
/*++
...
//=============================================================================
void
CODaAudioDriverHW::iSetDevSpecific
(
...
//=============================================================================
UINT
CODaAudioDriverHW::uiGetDevSpecific()
/*++
...
//=============================================================================
void
CODaAudioDriverHW::uiSetDevSpecific
(
...
//=============================================================================
BOOL
CODaAudioDriverHW::GetMixerMute
(
    _In_  ULONG                   ulNode,
...
//=============================================================================
LONG
CODaAudioDriverHW::GetMixerVolume
(   
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulChannel
)
...
//=============================================================================
LONG
CODaAudioDriverHW::GetMixerPeakMeter
(   
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulChannel
)
...
//=============================================================================
void
CODaAudioDriverHW::SetMixerMute
(
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulChannel,
    _In_  BOOL                    fMute
...
//=============================================================================
void  
CODaAudioDriverHW::SetMixerVolume
(   
    _In_  ULONG                   ulNode,
    _In_  ULONG                   ulChannel,
    _In_  LONG                    lVolume
