...
#pragma code_seg("PAGE")
NTSTATUS
ODaAudioDriverPropertyDispatch
(
    _In_ PPCPROPERTY_REQUEST PropertyRequest
)
/*++
    Handles and dispatches a ODAAUDIODRIVER_PROPERTY_ITEM.

    Use this as the property handler only if the property item is a
    ODAAUDIODRIVER_PROPERTY_ITEM.
--*/
{
    PAGED_CODE();

    ODAAUDIODRIVER_PROPERTY_ITEM* item = (ODAAUDIODRIVER_PROPERTY_ITEM*)PropertyRequest->PropertyItem;
