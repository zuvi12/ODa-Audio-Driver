...
CMiniportTopologyODaAudioDriver::CMiniportTopologyODaAudioDriver
(
...
} // CMiniportTopologyODaAudioDriver
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyODaAudioDriver::DataRangeIntersection
( 
    _In_  ULONG                 PinId,
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyODaAudioDriver::GetDescription
( 
...
#pragma code_seg("PAGE")
NTSTATUS
CMiniportTopologyODaAudioDriver::Init
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyODaAudioDriver::Init]"));
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyODaAudioDriver::PropertyHandlerGeneric
(
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyODaAudioDriver::PropertyHandlerMuxSource
(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
NTSTATUS                            
CMiniportTopologyODaAudioDriver::PropertyHandlerDevSpecific(
    _In_  PPCPROPERTY_REQUEST     PropertyRequest
)
/*++
...
#pragma code_seg("PAGE")
VOID
CMiniportTopologyODaAudioDriver::AddEventToEventList
(
...
#pragma code_seg()
VOID
CMiniportTopologyODaAudioDriver::GenerateEventList
(
    _In_opt_    GUID   *Set,
    _In_        ULONG   EventId,
    _In_        BOOL    PinEvent,
...
--*/
{
    DPF_ENTER(("[CMiniportTopologyODaAudioDriver::GenerateEventList]"));
