...
NTSTATUS
CreateMiniportTopologyODaAudioDriver
( 
...
--*/
{
    ...
    return CMiniportTopologyODaAudioDriver::GetDescription(OutFilterDescriptor);        
} // GetDescription
...
--*/
{
    ...
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Init: CMiniportTopologyODaAudioDriver::Init failed, 0x%x", ntStatus)),
        Done);
